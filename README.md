...
The portfolio links to available project source code. The previously displayed 87% NexusTrade impact figure has been removed pending reconciliation with the 250% figure in the resume drafts. Publish an impact percentage only with an agreed metric definition, baseline, comparison period, and supporting report.

The React rendering test and production build pass locally. A hosted deployment and end-to-end project demonstrations remain separate verification steps.
